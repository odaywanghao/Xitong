...
<div class="container" id="bookList">
	<!-- 书的列表 -->
	<h5>书的列表</h5>
	<?php $__FOR_START_243826632__=0;$__FOR_END_243826632__=$countBooks;for($i=$__FOR_START_243826632__;$i < $__FOR_END_243826632__;$i+=1){ ?><div id="book">
			<h5><?php echo ($allBooks[$i][bookname]); ?></h5>
			<img src="/Xitong/Uploads/BookPhotoes/<?php echo ((isset($allBooks[$i][picture] ) && ($allBooks[$i][picture] !== ""))?($allBooks[$i][picture] ):'/Xitong/Public/img/1.jpg'); ?>">
			<div id="bookInfo">
