...
<div id="header">
	<p>
		...
		<?php if(!empty($user)): ?><a href="/Xitong/index.php/Admin/Comments/logout">登出</a><?php endif; ?>
		<a class="showMore" href="#">更多</a>
	</p>
	<ul class="hidden_menu">
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Comments/myAllNotes">我的笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Comments/allNotes">所有笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Comments/allBooks">所有书目</a>
		</li>
	</ul>
</div>
...
<!-- 书的信息 -->
	<div id="book">
		...
		<div id="bookInfo">
		    ...
		    <span><?php echo ($bookzanCount); ?></span>
				<?php if($userDianzan == 1): ?><div class="heart" data-url="/Xitong/index.php/Admin/Comments/dianzan/"> </div>
				<?php else: ?>
					<div class="heart active" data-url="/Xitong/index.php/Admin/Comments/dianzan/"> </div><?php endif; ?>
			</div>
	...
	<div id="addComment">
		<h5>添加新评论</h5>
		<form method="post" action="/Xitong/index.php/Admin/Comments/addComment">
	...
	<!-- 书评列表 -->
	<h5>书评列表</h5>
	<?php $__FOR_START_1552630731__=0;$__FOR_END_1552630731__=$commentsCount;for($i=$__FOR_START_1552630731__;$i < $__FOR_END_1552630731__;$i+=1){ ?><div class="commentsList">
