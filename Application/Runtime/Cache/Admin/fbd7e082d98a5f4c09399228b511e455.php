...
<div id="header">
	<p>
		...
		<?php if(!empty($user)): ?><a href="/Xitong/index.php/Admin/Notes/logout">登出</a><?php endif; ?>
		<a class="showMore" href="#">更多</a>
	</p>
	<ul class="hidden_menu">
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Notes/myAllNotes">我的笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Notes/allNotes">所有笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Admin/Notes/allBooks">所有书目</a>
		</li>
	</ul>
</div>
...
<div class="container">
	...
	<div id="addNote">
		<h5>添加新笔记</h5>
		<a href="/Xitong/index.php/Admin/Notes/addNote">点击这...</a>
	</div>


	<!-- 笔记列表 -->
	<h5>笔记列表</h5>
	<?php $__FOR_START_1565095368__=0;$__FOR_END_1565095368__=$allNotesCount;for($i=$__FOR_START_1565095368__;$i < $__FOR_END_1565095368__;$i+=1){ ?><div class="bookAllNotesList">
			<div class="NoteBasic">
