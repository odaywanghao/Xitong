...
<div class="container">
	...
	<!-- 笔记列表 -->
	<h5>笔记列表</h5>
	<?php $__FOR_START_1741840715__=0;$__FOR_END_1741840715__=$allNotesCount;for($i=$__FOR_START_1741840715__;$i < $__FOR_END_1741840715__;$i+=1){ ?><div class="bookAllNotesList">
			<div class="NoteBasic">
			...
			<div class="NoteInfo">
				...
				<form method="post" url="/Xitong/index.php/Home/Notes/editNote/noteId/<?php echo ($allNotes[$i][id]); ?>)">
