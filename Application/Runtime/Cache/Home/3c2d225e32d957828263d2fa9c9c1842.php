...
<link rel="stylesheet/less" type="text/css" href="/newxx/Public/css/comments.less">
...
<div id="header">
	<p>
		...
		<?php if(!empty($user)): ?><a href="/newxx/index.php/Home/Comments/logout">登出</a><?php endif; ?>
		<a class="showMore" href="#">更多</a>
	</p>
	<ul class="hidden_menu">
		<li>
			<a class="clickNote" href="/newxx/index.php/Home/Comments/myAllNotes">我的笔记</a>
			<!-- <a class="clickNote" href="<?php echo U(myBookNotes);?>">我的笔记</a> -->

		</li>
		<li>
			<a class="clickNote" href="/newxx/index.php/Home/Comments/bookAllNotes">所有笔记</a>
...
<!-- 书的信息 -->
	<div id="book">
		...
		<img src="<?php echo ((isset($bookInfo[picture] ) && ($bookInfo[picture] !== ""))?($bookInfo[picture] ):'/newxx/Public/img/1.jpg'); ?>">
		<div id="bookInfo">
		    ...
		    <span><?php echo ($bookzanCount); ?></span>
				<?php if($userDianzan == 1): ?><div class="heart" data-url="/newxx/index.php/Home/Comments/dianzan/"> </div>
				<?php else: ?>
					<div class="heart active" data-url="/newxx/index.php/Home/Comments/dianzan/"> </div><?php endif; ?>
			</div>
	...
	<div id="addComment">
		<h5>添加新评论</h5>
		<form method="post" action="/newxx/index.php/Home/Comments/addComment">
	...
	<!-- 书评列表 -->
	<h5>书评列表</h5>
	<?php $__FOR_START_193145309__=0;$__FOR_END_193145309__=$commentsCount;for($i=$__FOR_START_193145309__;$i < $__FOR_END_193145309__;$i+=1){ ?><div class="commentsList">
			<img src="<?php echo ((isset($userHead ) && ($userHead !== ""))?($userHead ):'/newxx/Public/img/1.jpg'); ?>" alt="用户头像" />
			<div>
...
<script src="/newxx/Public/js/comments.js"></script>
